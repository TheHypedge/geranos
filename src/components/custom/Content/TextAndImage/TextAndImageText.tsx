...
const TextAndImageText = (props:any) => {
  return (
    <div className="order-[-1] xl:-order-none text-center md:text-left w-full flex flex-col align-middle justify-center gap-8 px-0 md:px-20">
    ...
    <div
      className="text-justify text-sm sm:text-base font-UrbanistLight tracking-wide"
