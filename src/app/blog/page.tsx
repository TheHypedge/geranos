  ...
  return (
    ...
    <div>
        ...
        <div className="bg-cover bg-[url('/global/banners/contact-6.jpg')] bg-top min-h-[320px] md:min-h-[420px] bg-slate-50">
            ...
            <h1 className="text-white text-4xl md:text-5xl font-semibold">Our Blogs</h1>
            ...
            <Link href="#cstmContId" id="cstmContId" className="max-w-min mx-auto">
              <Button className="max-w-min mx-auto font-normal text-xl md:text-2xl bg-transparent hover:bg-transparent border-2 border-white text-white p-4 md:p-6 rounded-full">
                Read Blog ↓
              </Button>
            </Link>
            </div>
